...
Namespace TraderServiceRef
    
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute(ConfigurationName:="TraderServiceRef.ITraderService")>  _
    ...
    Public Interface ITraderServiceChannel
        Inherits TraderServiceRef.ITraderService, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class TraderServiceClient
        Inherits System.ServiceModel.ClientBase(Of TraderServiceRef.ITraderService)
        Implements TraderServiceRef.ITraderService
        ...
        Public Function GetInvestmentList(ByVal userId As Long) As System.Data.DataSet Implements TraderServiceRef.ITraderService.GetInvestmentList
            Return MyBase.Channel.GetInvestmentList(userId)
        End Function
        
        Public Function GetInvestmentListAsync(ByVal userId As Long) As System.Threading.Tasks.Task(Of System.Data.DataSet) Implements TraderServiceRef.ITraderService.GetInvestmentListAsync
            Return MyBase.Channel.GetInvestmentListAsync(userId)
        End Function
        
        Public Function GetCostBasisPerShare(ByVal userId As Long) As Decimal Implements TraderServiceRef.ITraderService.GetCostBasisPerShare
            Return MyBase.Channel.GetCostBasisPerShare(userId)
        End Function
        
        Public Function GetCostBasisPerShareAsync(ByVal userId As Long) As System.Threading.Tasks.Task(Of Decimal) Implements TraderServiceRef.ITraderService.GetCostBasisPerShareAsync
            Return MyBase.Channel.GetCostBasisPerShareAsync(userId)
        End Function
        
        Public Function GetCurrentValue(ByVal userId As Long) As Decimal Implements TraderServiceRef.ITraderService.GetCurrentValue
            Return MyBase.Channel.GetCurrentValue(userId)
        End Function
        
        Public Function GetCurrentValueAsync(ByVal userId As Long) As System.Threading.Tasks.Task(Of Decimal) Implements TraderServiceRef.ITraderService.GetCurrentValueAsync
            Return MyBase.Channel.GetCurrentValueAsync(userId)
        End Function
        
        Public Function GetCurrentPrice(ByVal userId As Long) As Decimal Implements TraderServiceRef.ITraderService.GetCurrentPrice
            Return MyBase.Channel.GetCurrentPrice(userId)
        End Function
        
        Public Function GetCurrentPriceAsync(ByVal userId As Long) As System.Threading.Tasks.Task(Of Decimal) Implements TraderServiceRef.ITraderService.GetCurrentPriceAsync
            Return MyBase.Channel.GetCurrentPriceAsync(userId)
        End Function
        
        Public Function GetInvestmentTerm(ByVal userId As Long) As Short Implements TraderServiceRef.ITraderService.GetInvestmentTerm
            Return MyBase.Channel.GetInvestmentTerm(userId)
        End Function
        
        Public Function GetInvestmentTermAsync(ByVal userId As Long) As System.Threading.Tasks.Task(Of Short) Implements TraderServiceRef.ITraderService.GetInvestmentTermAsync
            Return MyBase.Channel.GetInvestmentTermAsync(userId)
        End Function
        
        Public Function GetGainLoss(ByVal userId As Long) As Decimal Implements TraderServiceRef.ITraderService.GetGainLoss
            Return MyBase.Channel.GetGainLoss(userId)
        End Function
        
        Public Function GetGainLossAsync(ByVal userId As Long) As System.Threading.Tasks.Task(Of Decimal) Implements TraderServiceRef.ITraderService.GetGainLossAsync
